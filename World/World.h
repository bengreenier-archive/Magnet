...
class World
{
    public:
        ...
        void AddBox(int x,int y,int x2,int y2,sf::Vector2f pos=sf::Vector2f(0,0),float degangle=0);
        void AddStaticBox(int x,int y,int x2,int y2,sf::Vector2f pos=sf::Vector2f(0,0),float degangle=0);
